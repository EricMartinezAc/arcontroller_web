...
export { type WorkItemsDTO as WFDTO } from "./PMI/workItems.dto";
export { type TicketsDTO as TICKET } from "./TI/tickets.dto";
export { type CIDTO as CI } from "./TI/configItem.dto";

export { type BranchDTO as BRANCH } from "./ENTIDADES/branches.dto";
export { type AreasDTO as AREA } from "./ENTIDADES/areas.dto";
export { type RRHHDTO as RRHH } from "./ENTIDADES/rrhh.dto";
